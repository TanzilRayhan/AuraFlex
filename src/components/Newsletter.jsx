...
const Newsletter = () => {
    ...
    return (
        ...
        data-aos-duration="1500" className='max-w-7xl mx-5 lg:mx-auto my-20'>
            <div className="card lg:card-side lg:gap-10 bg-slate-300">
                ...
                <div className="lg:w-4/5 card-body items-center justify-center">
                    <form>
                        ...
                        <fieldset className="form-control py-5 w-96">
